...
class RegionLoader {
  ...
  public function __construct(LevelFormat $fmt,$rX,$rZ) {
    ...
    $this->filePath = $this->formatProvider->getPath()."region/r.$rX.$rZ.mcr";
  ...
  public function readChunk($x,$z) {
    ...
    //file_put_contents("r$x,$z.r.dat",$data);
  ...
  public function writeChunk($oX,$oZ,$chunk) {
    ...
    //file_put_contents("r$oX,$oZ.w.dat",$chunkData);
  ...
  protected function writeChunkData($oX,$oZ,$data) {
    ...
    //echo "Chunk: $oX,$oZ at ".($this->locationTable[$index][0]).
    //" ($sectors)\n";
