...
class PMF{
  const PMF_CURRENT_VERSION = 0x01;
	...
	public function __construct($file, $new = false, $type = 0, $version = self::PMF_CURRENT_VERSION){
		if($new === true){
	...
	public function parseInfo(){
		...
		switch($this->version){
			case 0x01:
				...
				break;
			default:
				echo("[ERROR] Tried loading non-supported PMF version ".$this->version." on file ".$this->file."\n");
				return false;
		}
		return true;
	}
	...
	public function create($file, $type, $version = self::PMF_CURRENT_VERSION){
		$this->file = $file;
